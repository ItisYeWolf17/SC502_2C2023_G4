...
<head>
    ...
    <title>sistemass</title>
    <link rel="stylesheet" href="./assets/css/style.css" />
    <link rel="stylesheet" href="./assets/css/sistemass.css" />
...
<body>
    ...
    <h2 class="titulo-servicios">Estas en el Modulo Sistemas</h2>
...
<div class="container-table">
    ...
    <a class="titulo-servicios abrir-codigo" href="/addSistema">Añadir Sistema</a>

    <form action="/reporte-sistemas" method="post">
        <button class="titulo-servicios abrir-codigo">Generar Reporte</button>
    </form>
    <table id="datatable_sistemas" class="datatable">
        ...
        <tbody id="tableBody_sistemas"></tbody>
    </table>
</div>
