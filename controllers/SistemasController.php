...
class SistemasController
{
    ...
    public static function generarReporte()
    {
        ...
        $pdf->SetTitle('Reporte de Sistemas');
        ...
        $pdf->Cell(85, 6, 'LISTA DE SISTEMAS', 0, 0, 'C');
        ...
        foreach ($sistemas as $sistema) {
            $pdf->Cell(60, 6, $sistema->id, 1, 0, 'C');
            $pdf->Cell(60, 6, $sistema->nombre_sistema, 1, 1, 'C');
        }

        $pdf->Output('Reporte-Sistemas' . date('d_m_y') . '.pdf', 'I');
